...
pub const SNOWFLAKE_DRIVER_VERSION: &str = "0.18.0+dbt0.0.16";
pub const BIGQUERY_DRIVER_VERSION: &str = "0.18.0+dbt0.0.15";
...
pub const SALESFORCE_DRIVER_VERSION: &str = "0.18.0+dbt0.0.3";
